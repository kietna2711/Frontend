...
export default function OrderManagement() {
  ...
  const updateOrderStatus = (id: string, status: string) => {
    axios
      .put(`http://localhost:3000/orders/${id}`, { orderStatus: status })
      .then((res) => {
        setOrders((orders) =>
          orders.map((order) =>
            order._id === id
                      ...
                      <tr key={order._id}>
                        ...
                        <td>
                          ...
                          <small className="text-muted">
                            ...
                            đ + Ship: {order.shippingFee?.toLocaleString()} đ)
                          </small>
                        </td>
                        ...
                        <td>
                          <span
                            className={`badge ${
                              statusBadge[order.orderStatus] || "bg-secondary"
                            }`}
                          >
                            {statusOptions.find(
                              (opt) => opt.value === order.orderStatus
                        ...
                        <td>
                          <select
                            ...
                            disabled={
                              getNextStatusOptions(order.orderStatus).length ===
                              0
                            }
                          >
