        ...
        {hasVariants ? (
          ...
          >
            {product.variants.map((v) => (
              <option value={v.size} key={v.size}>
                {v.size}
              </option>
            ))}
          </select>
        ...
        <div className={styles.quantityControls}>
          {quantity > 1 ? (
            ...
            <Popconfirm
              ...
              onConfirm={() =>
                dispatch(
                  removeFromCart({ _id: product._id, size: currentSize })
                )
              }
              ...
              okButtonProps={{
                style: { background: "#ea4c89", borderColor: "#ea4c89" },
              }}
              cancelButtonProps={{
                style: {
                  color: "#ea4c89",
            ...
            >
              <button onClick={() => setShowPop(true)}>-</button>
            </Popconfirm>
          )}
